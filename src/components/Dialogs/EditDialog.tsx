...
const EditDialog: FC<dialogType> = ({vegaInstance, onClose, onEditClick}) => {
    ...
    useEffect(() => {
        setSimpleStyles({
            width: vegaInstance.vega.width,
            height: vegaInstance.vega.height,
            background: vegaInstance.vega.background
        })
        setTransform(vegaInstance.vega.transform)
        setMark({mark: vegaInstance.vega.mark})
            ...
            <Box style={{height: '100%'}}>
                ...
                <Box className={classes.inputBox}>
                    <Typography variant={'body1'} color={'secondary'}>
                        Edit data and styles! To refresh data, press the refresh button.
                    </Typography>
